...
def member_registration(request):
        ...
        #  store data in feedback table and send message to member_registration.html
         ...
         member_reg_obj=Member(member_id=user_id,password=user_password,name=user_name,phone=user_phone,email=user_email,gender=user_gender,city=user_city,address=user_address,profile_picture=user_pic)#creating Member class object
