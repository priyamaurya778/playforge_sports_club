...
from . import views, member_views, coach_views
...
urlpatterns = [
    ...
    path("member_sessions/",      coach_views.member_sessions,       name="member_sessions"),
    path('search_results/',       views.search_results,              name='search_results'),

    # ── Coach portal ──
    path("coach_login/",          coach_views.coach_login,           name="coach_login"),
    path("coach_dashboard/",      coach_views.coach_dashboard,       name="coach_dashboard"),
    path("coach_logout/",         coach_views.coach_logout,          name="coach_logout"),
    path("coach_edit_profile/",   coach_views.coach_edit_profile,    name="coach_edit_profile"),
    path("coach_member_detail/<str:member_id>/", coach_views.coach_member_detail, name="coach_member_detail"),
    path("coach_message_board/",  coach_views.coach_message_board,   name="coach_message_board"),
    path("coach_session_planner/",coach_views.coach_session_planner, name="coach_session_planner"),
    path("coach_announcements/",  coach_views.coach_announcements,   name="coach_announcements"),
]
